  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: OnboardingAppBar(
        stepNumber: 6,
        title: context.l10n.onboarding_bodyCompositionSelectionTitle,
      ),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              Text(context.l10n.onboarding_bodyCompositionSelectionDescription),
    ...
    return SizedBox(
      ...
      child: ButtonTheme(
        ...
        child: DropdownButtonFormField(
          decoration: InputDecoration(label: Text(context.l10n.onboarding_bodyCompositionSelectionLabel)),
          items:
